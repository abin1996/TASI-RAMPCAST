...
typedef enum { SCH_SUBH_TYPE = 0, MCH_SUBH_TYPE = 1, SLSCH_SUBH_TYPE = 2 } subh_type;
...
{
public:
  slsch_pdu(uint32_t max_subh): pdu(max_subh, NULL) {};
  slsch_pdu(uint32_t max_subh, srslte::log* log) : pdu(max_subh, log) {};
